...
{
    class Level5State : IScenarioState
    {
        ...
        public void Execute(Scenario context)
        {
            ...
            switch (context.MainScreen(menu_p0, context.Plot, "poziom1_5", Photos.plane))
            {
                case 98:
                ...
                case 99:
                    ...
                    break;
                default:                    
                    context.Planet1.Combat(context.Player, Photos.droid4);
